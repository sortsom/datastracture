            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                       aria-controls="home" aria-selected="true">ចុះឈ្មោះ</a>
                </li>
            </ul>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right ">
                                    <button class="btn btn-secondary  "><a href="#" class="text-white"><i
                                                class="fas fa-arrow-circle-left"></i>ត្រឡប់វិញ</a></button>
                                    <button class="btn btn-danger ml-2"><a href="#" class="text-white"><i
                                                class="far fa-save"></i>រក្សាទុក</a></button>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div>
                        ...
                        <form action="{{route('admin.teachers.update',$teacher)}}" method="post">
                            ...
                            <div class="row">
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="text" class="form-control" name="lnamek"
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="text" class="form-control" name="funamek"
                                           aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
                                           placeholder="នាមត្រកូលឡាតាំង">
                                </div>
                                <div class="input-group input-group-sm mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <input type="date" class="form-control" name="db" aria-label="Sizing example input"
